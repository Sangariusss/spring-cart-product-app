package com.sangarius.springcartproductapp;

import static org.junit.jupiter.api.Assertions.assertEquals;

import com.sangarius.springcartproductapp.config.AppConfig;
import com.sangarius.springcartproductapp.model.Cart;
import com.sangarius.springcartproductapp.model.Product;
import com.sangarius.springcartproductapp.service.CartServiceImpl;
import com.sangarius.springcartproductapp.service.ProductServiceImpl;
...
class CartServiceTest {
    ...
    void testGetProductQuantity() {
        ...
        assertEquals(4, cartService.getProductQuantity(cart, product1));
    }
    ...
    void testProductNotInCartReturnsZero() {
        ...
        assertEquals(0, cartService.getProductQuantity(cart, product2));
    }
}